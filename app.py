...
class CustomerInput(BaseModel):
    ...
    SeniorCitizen: str = Field(..., json_schema_extra={"example": "0"})
    Partner: str = Field(..., json_schema_extra={"example": "Yes"})
    Dependents: str = Field(..., json_schema_extra={"example": "No"})
    tenure: float = Field(..., json_schema_extra={"example": 1.0})
    ...
    TotalCharges: Optional[float] = Field(None, json_schema_extra={"example": 29.85})
